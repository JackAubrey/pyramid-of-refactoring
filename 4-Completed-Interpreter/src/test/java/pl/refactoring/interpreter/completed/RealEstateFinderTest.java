...
public class RealEstateFinderTest {
    ...
    private static final RealEstateFinder FINDER = new RealEstateFinder(createProductRepository());
    ...
    public void findWoodenSmallProperty() {
        ...
        //then
        assertThat(foundResults)
                .containsExactlyInAnyOrder(WOODEN_VILLAGE_BUNGALLOW);
    }
    ...
    public void findStoneCastlesInTowns() {
        ...
        //then
        assertThat(foundResults)
                .containsExactlyInAnyOrder(STONE_TOWN_CASTLE);
    }
}
